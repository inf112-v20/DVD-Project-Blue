...
//            ICard card = player.getDealtCards()[0];
//            assertEquals(true, player == card.getPlayer());
//            assertEquals(false, card == null);
//            assertEquals(true, player.getDealtCards()[0] instanceof ICard);
//        }
//
//    }
//
...
//        round.dealCards();
//        for (Player player: players) {
//            ICard[] receivedCards = player.getDealtCards();
