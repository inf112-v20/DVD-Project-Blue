 ...
 */
public class DizzyDash implements IBoard {

    private final String mapName = "Dizzy Dash";
    private final String filePath = "Boards/DizzyDash.tmx";
    private final String mapImage = "Boards/DizzyDash.png";
